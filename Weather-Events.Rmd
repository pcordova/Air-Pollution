...
We need to know the monetary value of property and crop losses:
```{r}
...
cost[order(-Fatalities,-Injuries,-propLoss,-cropLoss)] %>% datatable(caption = "Total Weather Events in the U.S., from Deadliest to less Harmful (1950-2011)")
